...
Version  : 1.0.10
Release  : 23
URL      : https://github.com/clearlinux/clr-init/archive/V1.0.10.tar.gz
Source0  : https://github.com/clearlinux/clr-init/archive/V1.0.10.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1559360842
