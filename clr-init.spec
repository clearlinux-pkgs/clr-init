...
Version  : 0.1.1
Release  : 1
URL      : https://github.com/clearlinux/clr-init/archive/V0.1.1.tar.gz
Source0  : https://github.com/clearlinux/clr-init/archive/V0.1.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1516654690
