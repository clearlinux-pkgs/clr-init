...
Source0  : https://github.com/clearlinux/clr-init/archive/V1.0.18.tar.gz
...
%prep
%setup -q -n clr-init-1.0.18
cd %{_builddir}/clr-init-1.0.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624314769
...
cp %{_builddir}/clr-init-1.0.18/COPYING %{buildroot}/usr/share/package-licenses/clr-init/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
